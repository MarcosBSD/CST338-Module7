...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] titleArr = { "300", "311", "325", "334", "336", "338", "363", "370", "383"};
        String[] descArr = { getString(R.string.name300), getString(R.string.name311),
        ...
        final String[] classDescription = {getString(R.string.desc300), getString(R.string.desc311),
                getString(R.string.desc325), getString(R.string.desc334),
                getString(R.string.desc336), getString(R.string.desc338),
                getString(R.string.desc363), getString(R.string.desc370),
                getString(R.string.desc383)};
